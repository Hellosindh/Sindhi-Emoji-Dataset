...
هي **[هيلوسنڌ (HelloSindh.com)](https://hellosindh.com)** پاران هڪ اوپن سورس پروجيڪٽ آهي، جنهن ۾ معياري يونيڪوڊ ايموجيز جو سنڌي ترجمو ۽ لاڳاپيل لفظ (Keywords) ڏنا ويا آهن.
...
هن پروجيڪٽ جي سموري ڊيٽا `emojis-data.js` فائيل ۾ موجود آهي. 

* **ٻه لساني سپورٽ (Bilingual Support):** انگريزي (`name_en`, `keywords_eng`) ۽ سنڌي (`name_sd`, `keywords_sd`) ٻنهي ٻولين ۾ نالا ۽ لفظ موجود آهن.
* **سرچ لاءِ لفظ (Rich Keyword Mapping):** هر ايموجي سان گڏ پائپ (`|`) سان ڌار ٿيل لفظ شامل آهن جيئن سرچ ڪرڻ ۾ آساني ٿئي (مثال طور: "مرڪڻ" يا "خوش" لکڻ سان "😀" سرچ ٿيڻ).
* **ڪيٽيگريز (Categorized):** ايموجيز کي انهن جي ڪيٽيگريز جي حساب سان ورهايو ويو آهي (مثال طور: `smileys_emotion`، `people_body`).
* **معياري يونيڪوڊ (Standardized Unicode):** هر ايموجي جو يونيڪوڊ (مثال: `U+1F600`) پڻ ڏنل آهي ته جيئن رينڊرنگ ۾ ڪو مسئلو نه اچي.

---

## 📂 ڊيٽا جي بناوٽ

پروجيڪٽ جي ڊيٽا `emojis-data.js` فائيل اندر `window.EMOJI_DATA` نالي ايري (Array) ۾ رکيل آهي. 

هر هڪ ايموجي جي ڊيٽا جو ڍانچو ڪجهه هن طرح آهي:
